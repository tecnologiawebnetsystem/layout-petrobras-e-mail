    ...
    <div className="bg-card/50 backdrop-blur-sm rounded-2xl shadow-xl border p-8 space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-start justify-between">
                <div className="space-y-1">
                  <p className="font-semibold text-foreground">
                    {supervisorDoSupervisor.name}
                  </p>
                  <p className="text-sm text-muted-foreground">
                    {supervisorDoSupervisor.email}
                  </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-amber-700 dark:text-amber-600 leading-relaxed">
                  Não foi possível identificar seu superior hierárquico. Você
        ...
        <div className="space-y-3">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Os arquivos ficarão disponíveis para download por {expirationHours}{" "}
