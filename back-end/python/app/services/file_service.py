...
def gerar_download_url_simulada(file_key: str, expires_in: int = 300, filename: str | None = None) -> str:
...
def gerar_download_url(file_key: str, expires_in: int = 300, filename: str | None = None) -> str:
    if settings.storage_provider == "local":
        return gerar_download_url_simulada(file_key, expires_in, filename)
    else:
