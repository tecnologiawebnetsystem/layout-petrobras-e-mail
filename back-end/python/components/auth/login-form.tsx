...
export function LoginForm() {
  ...
  const handleEntraIdLogin = async () => {
    try {
      console.log(" Iniciando login com Entra ID via popup")
      const response = await instance.loginPopup(loginRequest)
      console.log(" Response do loginPopup recebido:", {
      ...
      if (response && response.account) {
        console.log(" Login bem-sucedido, conta salva no MSAL")
        console.log(" Forçando evento de login para o provider processar")
      ...
      console.error(" Erro no loginPopup:", error)
