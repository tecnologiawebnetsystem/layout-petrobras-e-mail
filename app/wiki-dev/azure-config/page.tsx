                  ...
                  <div className="space-y-2 rounded-lg bg-slate-50 p-4 font-mono text-sm">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <code className="text-slate-900">da3aaaad-619f-4bee-a434-51efd11faf7c</code>
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => copyToClipboard("da3aaaad-619f-4bee-a434-51efd11faf7c", "hml-client")}
                        >
                          {copied === "hml-client" ? (
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <code className="text-slate-900">5b6f6241-9a57-4be4-8e50-1dfa72e79a57</code>
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => copyToClipboard("5b6f6241-9a57-4be4-8e50-1dfa72e79a57", "hml-tenant")}
                        >
                          {copied === "hml-tenant" ? (
                            <CheckCircle className="h-4 w-4 text-green-600" />
                          ) : (
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <code className="text-slate-900">AAD-DEV-A12022</code>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <ol className="space-y-3 text-sm">
                    ...
                    <li className="flex gap-3">
                      ...
                      <span>Azure Active Directory → App registrations → AAD-DEV-A12022</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-blue-100 text-xs font-semibold text-blue-600">
                        3
                ...
                <div>
                  ...
                  <ol className="space-y-3 text-sm">
                    <li className="flex gap-3">
                      ...
                      <span>Azure AD → App registrations → AAD-DEV-A12022</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-purple-100 text-xs font-semibold text-purple-600">
                        2
