                  ...
                  <div className="rounded-lg border p-4 bg-slate-50">
                    <div className="flex items-center gap-4 flex-wrap">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-slate-500">Porta 8080</span>
                      </div>
                    </div>
                  </div>
                </div>
...
# Teste a API em: http://localhost:8080
# Veja a documentacao em: http://localhost:8080/docs
                  ...
                  <CardContent>
                    <div className="grid gap-3 md:grid-cols-3">
                      <div className="rounded-lg border border-green-300 bg-white p-4">
                        ...
                        <p className="text-sm text-slate-600">http://localhost:8080</p>
                      </div>
                      <div className="rounded-lg border border-green-300 bg-white p-4">
                        <FolderOpen className="h-5 w-5 text-green-600 mb-2" />
                        <strong>Swagger (Docs)</strong>
                        <p className="text-sm text-slate-600">http://localhost:8080/docs</p>
                      </div>
                      <div className="rounded-lg border border-green-300 bg-white p-4">
...
services:
  ...
  # =============================================
  # BACK-END (Python/FastAPI) - Porta 8080
  # =============================================
  api:
    build:
