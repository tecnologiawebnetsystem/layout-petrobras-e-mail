...
export default function SuportePage() {
  ...
  // Aguarda a hidratacao do Zustand persist antes de checar auth,
  // evitando redirect indevido para "/" no primeiro render.
  useEffect(() => {
    if (!_hasHydrated) return

    const timer = setTimeout(() => {
      if (!isAuthenticated || !hasSuportAccess) {
        router.push("/")
      } else {
  ...
  }, [_hasHydrated, isAuthenticated, hasSuportAccess, router])
